...
export default function Booking() {
  ...
  function updateSelectedTimeRange() {
    ...
    if (hasConflict) {
      setConflictWarning("Your selected time range includes unavailable slots.");
      setForm((prev) => ({
        ...prev,
        start_time: "",
        end_time: "",
  ...
  function selectedFacilityName() {
    return (
      facilities.find((facility) => facility.id === form.facility_id)?.name || "No facility selected"
    );
  }
            ...
            <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
              <div>
                <p className="text-sm font-medium text-blue-100">
                  Smart Multi-Slot Booking
                </p>
                <h2 className="mt-2 text-3xl font-bold tracking-tight md:text-4xl">
                  Reserve one or multiple consecutive facility slots.
                </h2>
                <p className="mt-3 max-w-2xl text-sm text-blue-100 md:text-base">
                  Select a facility, choose a date, then highlight a time range.
                  Conflicts are checked before submission.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 gap-3 md:w-[320px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <p className="mt-2 text-lg font-semibold">{selectedFacilityName()}</p>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <p className="text-xs uppercase tracking-[0.18em] text-blue-100">
                    Selected Range
          ...
          <div className="grid grid-cols-1 gap-6 xl:grid-cols-3">
            <Card className="xl:col-span-2">
              <div className="mb-6">
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Choose a facility, date, and one continuous time range.
                </p>
              </div>
            ...
            <Card>
              <div className="mb-5">
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Your most recent facility requests.
                </p>
              </div>
